...
app=FastAPI(title='WorkTime Sync Backend',description='FastAPI backend для WorkTime Sync: аналитика, роли, задачи, подтверждения и применение решений.',version='2.5.0')
...
@app.get('/tasks')
def get_tasks(user_id:str|None=None,status:str|None=None,department:str|None=None,authorization:str|None=Header(default=None)):
